...
//            if (!(this.getPositionX() == 0 || this.getPositionX() == 400)){
			BossBullet bullet1 = new BossBullet(boss.getPositionX() + boss.getWidth() / 2 - 3 + 70, boss.getPositionY(), 0, 5,6,10, "ZigZagAngryPattern");
			BossBullet bullet2 = new BossBullet(boss.getPositionX() + boss.getWidth() / 2 - 3 - 70, boss.getPositionY(), 0, 5,6,10, "ZigZagAngryPattern");
			bullets.add(bullet1);
			bullets.add(bullet2);
//            }
		}
